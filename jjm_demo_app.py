...
+
+    merged_all = ensure_columns(readings.copy(), ["id","scheme_id","jalmitra","reading","reading_date","reading_time","water_quantity","scheme_name","so_name"]).merge(
+        ensure_columns(schemes.copy(), ["id","scheme_name","functionality","so_name","ideal_per_day","scheme_label"])[["id","scheme_name","functionality","so_name","ideal_per_day","scheme_label"]],
+        left_on="scheme_id", right_on="id", how="left", suffixes=("_reading","_scheme")
+    )
+
